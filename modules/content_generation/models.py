...
class ContentDraft(BaseModel):
    ...
    id: Optional[str] = Field(None, description="Draft ID")
    founder_id: str = Field(..., description="Founder ID")
    content_type: ContentType = Field(..., description="Type of content")
    generated_text: str = Field(..., min_length=1, max_length=2000, description="Generated content")
    trend_id: Optional[str] = Field(None, description="Source trend ID")
    source_tweet_id: Optional[str] = Field(None, description="Source tweet for replies")
    seo_suggestions: SEOSuggestions = Field(default_factory=SEOSuggestions)
    quality_score: Optional[ContentQualityScore] = Field(None, description="Quality assessment")
